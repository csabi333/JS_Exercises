...
form.addEventListener('submit',function(e){
  e.preventDefault(); //prevent form sending to non existent server
  //console.log("hello");
  const value = parseInt(amount.value);
  const random =Math.floor(Math.random()*text.length);
  //console.log(typeof value); //careful its a string even tho input type is number
  //in the console strigns are black and numbers are blue after consloe.log
  //empty
  //negative
  //more than 9
